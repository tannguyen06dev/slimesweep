...
public class PoliceSiren : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // SỬA ĐỔI: Thay thế "Standard" bằng "Lpk/LightModel/ToonLightBase"
        defShader = Shader.Find("Lpk/LightModel/ToonLightBase");

        unlitShader = Shader.Find("Lpk/LightModel/ToonLightBase");
    }
